      ...
      <div className="container mx-auto h-full flex flex-col xl:flex-row items-center z-30 relative">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Main Hero Heading */}
            <h1 className="h1 text-white max-w-[980px]">
              <span className="text-accent">Sciascia Caffè</span> 1919
            </h1>
          </div>
          ...
          <p className="lead font-light max-w-[300px] md:max-w-[430px] xl:max-w-[560px] mb-4">
            Experience classic coffee tradition in a cozy space, where every cup is
